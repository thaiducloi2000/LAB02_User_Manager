...
public class FilterController implements Filter {
    ...
    private static final String ERORR="login.jsp";
	...
	try {
	    ...
	    if(resource.endsWith(".jsp")||resource.endsWith(".css")||resource.endsWith(".html")||resource.contains(".jpg") || resource.contains(".png")){
		url=resource;
	    }
	    if(url!=null){
